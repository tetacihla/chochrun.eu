<!--********************************************* Main start *********************************************-->
            ...
            <div id="full_page_wrapper">
                ...
                <div class="header">
                	<h2><span>chochrun.eu //</span> Několik slov o nás</h2>
                </div>
                ...
                <div id="post_wrapper">
                    ...
                    <div id="body">
						...
						<h2>Koho hledáme?</h2>
                    	<p>Lidi do Banlistu. Ano, je to vážně tak, existuje tu jistá možnost finanční podpory našeho serveru, která spočívá v tom, že se dotyčný s majitelem dohodne na ceně a ten uživatele následně zabanuje na IP adresu. Cena je určována <b>přísně individuálně</b>, tedy stejně jako dávka antipsychotik nebo morfia u nesklidnitelných pacientů. Záleží též na psychickém rozpoložení žadatele. Bude-li žádost napsána nekorektně, neformálně a neeticky, či dokonce vulgárně, tak se na dotyčného s největší pravděpodobností vyseru a jeho žádostem budu i nadále odmítat vyhovět.<br>S pozdravem Mr.Chochrun, správce a majitel tohoto portálu </p>
